#!/bin/bash
# start.sh
# Starts the codecompass FastAPI backend and React frontend together.
...
uvicorn codecompass.api:app --host 0.0.0.0 --port 8000 --reload &
BACKEND_PID=$!
